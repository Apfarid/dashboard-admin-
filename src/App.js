...
import GestorMorosos from "./views/mora/GestorMorosos";
...
import Mora from "./views/mora/Morosos";
        ...
        <Provider store={store}>
          <Sidebar>
            <Switch>
              ...
              <Route
                exact
                path="/gestor-nuevo-credito/solicitudes-nuevos"
                component={GestorCreditoNuevo}
              />
              <Route
                exact
                path="/gestor-nuevo-credito/aprobados"
                component={GestorCreditoAprobados}
              />
              <Route
                exact
                path="/gestor-datos"
                component={GestorDatosPersonales}
              />
              ...
              <Route
                exact
                path="/gestor-nuevo-credito/preaprobado-con-documentos"
                component={GestorCreditoConDocumento}
              />
              <Route
                path="/gestor-nuevo-credito/preaprobado-con-documentos/:id"
                component={VistaConDocumentos}
              />

              <Route
                exact
                path="/gestor-nuevo-credito/preaprobado-sin-documentos"
                component={GestorCreditoSinDocumento}
              />
              <Route
                path="/gestor-nuevo-credito/preaprobado-sin-documentos/:id"
                component={VistaSinDocumentos}
              />

              <Route
                exact
                path="/gestor-nuevo-credito/renovacion"
                component={GestorCreditoRenovacion}
              />
              <Route
                path="/gestor-nuevo-credito/renovacion/:id"
                component={VistaRenovacion}
              />

              <Route
                exact
                path="/gestor-creditos-general"
                component={GestorCreditosGeneral}
              />
              ...
              <Route exact path="/moratorios" component={Mora} />
              <Route exact path="/moratorios/:id" component={GestorMorosos} />
            </Switch>
          </Sidebar>
        </Provider>
      </Router>
